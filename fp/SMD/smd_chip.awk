BEGIN {
	...
	if (x > y) {
		element_pad(-c/2, -(x/2 - y/2), -c/2, x/2 - y/2, y, 1, shape == "square" ? "square" : "", "", y + 800)
		element_pad(c/2, -(x/2 - y/2), c/2, x/2 - y/2, y, 2, shape == "square" ? "square" : "", "", y + 800)
	} else {
		element_pad(-(c/2 + (y/2 - x/2)), 0, -(c/2 - (y/2 - x/2)), 0, x, 1, shape == "square" ? "square" : "", "", x + 800)
		element_pad(c/2 - (y/2 - x/2), 0, c/2 + (y/2 - x/2), 0, x, 2, shape == "square" ? "square" : "", "", x + 800)
	}
